...
void main() {
  ...
  group('newest books cubit', () {
    test(
        'fetch Newest Books and it will emit Newest Books Loading then Newest Books Success with  Book Model',
        () {
      // arrange
    ...
    test(
        'fetch Newest Books and it will emit Newest Books Loading then Newest Books Success with Server Failure',
        () {
      // arrange
      ...
      // assert
      final expectedStates = [const NewestLoading(), NewestFailure('error')];
